...
public class BodyPartFragment extends Fragment {
    ...
    private final static String INDEX = "mIndex";
    private final static String LISTIMAGES = "mImageIds";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            mImageIds = savedInstanceState.getIntegerArrayList(LISTIMAGES);
    ...
    {
        currentState.putIntegerArrayList(LISTIMAGES, (ArrayList<Integer>)mImageIds);
